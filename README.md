...
You can however lookup the verified bank account number for the business with company number 5566778. These records were already added to the smart contract.
